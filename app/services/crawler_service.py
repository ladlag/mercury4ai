    ...
    try:
        ...
        if extracted:
            ...
            try:
                ...
                # Use original string length for efficiency (avoids re-serialization)
                # Note: Size may differ from json.dumps() due to formatting, but represents actual API response size
                output_size = len(extracted)
